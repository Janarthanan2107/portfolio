      ...
      <div className="flex justify-between items-center border-b border-b-gray-500 pb-[3rem]">
        ...
        <div className="menu">
          <ul className="flex gap-7 text-[1.2rem]">
            <li className="cursor-pointer hover:text-primary hover:border-b-primary">Home</li>
            <li className="cursor-pointer hover:text-primary hover:border-b-primary">Skills</li>
            <li className="cursor-pointer hover:text-primary hover:border-b-primary">Portfolio</li>
            <li className="cursor-pointer hover:text-primary hover:border-b-primary">Contact</li>
          </ul>
        </div>
