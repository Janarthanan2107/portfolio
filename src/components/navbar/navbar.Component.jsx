      ...
      <div className="flex justify-between items-center m-5">
        ...
        <div className="menu">
          <ul className="flex gap-7 text-[1.1150rem]">
            <li className="cursor-pointer hover:text-primary border-b border-b-white hover:border-b-primary">Home</li>
            <li className="cursor-pointer hover:text-primary border-b border-b-white hover:border-b-primary">Skills</li>
            <li className="cursor-pointer hover:text-primary border-b border-b-white hover:border-b-primary">Portfolio</li>
          </ul>
        </div>
